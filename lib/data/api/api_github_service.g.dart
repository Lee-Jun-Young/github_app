...
part of 'api_github_service.dart';
...
class _ApiGithubService implements ApiGithubService {
  _ApiGithubService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<List<RepositoryInfo>> getRepos(String owner) async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<RepositoryInfo>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => RepositoryInfo.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }

  @override
  Future<UserInfo> getUserById(String user) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
